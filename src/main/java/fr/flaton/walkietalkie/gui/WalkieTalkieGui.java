...
import fr.flaton.walkietalkie.widget.TButton;
...
public class WalkieTalkieGui extends LightweightGuiDescription {
    ...
    public WalkieTalkieGui(ItemStack stack) {
        ...
        WLabel label = new WLabel(Text.translatable("gui.walkietalkie.label"));
